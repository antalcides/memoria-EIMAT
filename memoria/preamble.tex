...
\fancypagestyle{eimat}{
 %% Clear all headers and footers
  ...
  \fancyfoot[RO,LE]{\tikz[baseline]\node[pagefooter]{\thepage};}
   \fancyhead[LE]{
   %% Then the right mark and the decorative line
    \sffamily\itshape\small\protect\nouppercase{IX ENCUENTRO INTERNACIONAL DE MATE\'ATICAS - EIMAT}\ 
    \begin{tikzpicture}[xshift=.5\baselineskip,yshift=.25\baselineskip,remember picture, overlay,fill=ptctitle,draw=ptctitle]
    \fill (0,0) circle (3pt); \draw[semithick](0,0) -- (current page.east |- 0,0 );
       \end{tikzpicture}}
   \fancyhead[RO]{
...
\linespread{1.5}\selectfont
 \raggedleft 
 #1}{}
 %%%%%%%%%%%%%%%%Bibliograf\'ia como secci\'on
 \renewcommand{\titlerule}{\vbox to 0pt{\hbox
to\headwidth{\color{gris}{\dotfill}}\vss}}
 \makeatletter
...
\renewenvironment{abstract}{\global\setbox\absbox=\vbox\bgroup
 ...
 %%%%%%%%%%%%%%%%%
 \renewenvironment{resumen}{\global\setbox\resubox=\vbox\bgroup
  \hsize=\textwidth\def\baselinestretch{1}%
...
\def\palabras{%
 ...
 \def\MSC{\@ifnextchar[{\@MSC}{\@MSC[2000]}}
  ...
  \def\PACS{\par\leavevmode\hbox {\it PACS:\space}}%
  \def\JEL{\par\leavevmode\hbox {\it JEL:\space}}%
  \global\setbox\palabox=\vbox\bgroup\hsize=\textwidth
  \normalsize\normalfont\def\baselinestretch{1}
  \parskip\z@
  \elsarticle@absfont\noindent\textit{Palabras claves: }
  \raggedright                         % Keywords are not justified.
  \ignorespaces}
\def\endpalabras{\par \egroup}
\makeatother 
%%%%%%%%%%secciones
